export default [
  ...
  '1H-Pyrazole-3-carboxamide, 5-amino-1-[2,6-dichloro-4-(trifluoromethyl)phenyl]-4-[(trifluoromethyl)sulfinyl]-***retired***use Fipronil amide',
  ...
  '4-Nonylphenol monoethoxylates***retired***use Ethanol, 2-(4-nonylphenoxy)-',
  ...
  'Acanthamoeba tubiashi***retired***use Acanthamoeba _tubiashi (Protozoa)',
  'Acanthamoeba***retired***use Acanthamoeba (Protozoa)',
  'Acid Neutralization Potential_as CaCO3 As %CaCO3***retired***use Acid Neutralization Potential as CaCO3',
  ...
  'Desvenlafaxine***retired***use Desmethylvenlafaxine',
  ...
  'Endosulfan, alpha***retired***use .alpha.-Endosulfan',
  ...
  'Isoxaflutole acid RPA 203328***retired***use 2-(Methylsulfonyl)-4-(trifluoromethyl)benzoic acid',
  ...
  'Tebupirimfos***retired***use Phostebupirim',
  'Tebuthiuron Transformation Product 109***retired***use Hydroxytebuthiuron',
  ...
  'alpha-HCH (aLindane)***retired***use .alpha.-Hexachlorocyclohexane',
