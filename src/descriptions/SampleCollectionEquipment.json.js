export default {
  ...
  'Activity Trap': '',
  'Anchor Box Dredge':
    'A device which can operation on both packed sandy bottom and muddy ground. Derived from the anchor dredge but includes a metal box protecting the net and a mechanical opening and closing mechanism.',
  ...
  'Boomerang Corer':
    'Device can be dropped over the side of a moving ship, where it will sink rapidly to the ocean floor, take a core of sediment, release ballast, and automatically return to the surface for retrieval.',
  'Boomerang Grab':
    'Free falling samplers that weigh approximately 85 kg and are deployed directly from the side of a boat. ',
  'Box Corer':
  ...
  'Box Sampler':
    'A tool used for the quantitative analysis of macroinvertebrates.  Types of boxes include Gerking, 1957 and Anderson and Smith 1996.',
  Brail: '',
  Bucket: 'Sampling water with a bucket.',
  'Burrell Epibenthic Sled':
    'An instrument designed to collect benthic and benthopelagic faunas from the deep sea. The sled is made from a steel frame consisting of two skids and stabilizing planes to keep it from sinking too deep into the mud. ',
  'Campbell Grab': 'A grab bucket.',
  'Cast Net':
    "Also called a throw net, is a net used for fishing. It is a circular net with small weights distributed around its edge. The net is cast or thrown by hand in such a manner that it spreads out while it's in the air before it sinks into the water. This technique is called net casting or net throwing. Fish are caught as the net is hauled back in. This simple device is particularly effective for catching small bait or forage fish, and has been in use, with various modifications, for 1000 years.",
  'Center Bag': '',
  'Chain Dredge':
    'A dredge chain is the cutting and conveying mechanism found on chain ladder dredges. The main function of a dredge chain is to agitate and excavate material while keeping the suction clear for pumping. ',
  'Churn Splitter':
    'A churn splitter is used to ensure that subsamples accurately represent a composite sample. ... Churn splitters—or churns—are used to mix a composited sample and simultaneously dispense it into bottles for laboratory analysis.',
  'Clam-Shell Grab':
  ...
  'Clarke-Bumpus Net':
    'Zooplankton collection system that could be deployed as multiple units on the wire and had a positive means of opening and closing the mouth of the net.',
  Concussion: '',
  'Creel Survey':
  ...
  'DH-81':
    'A lightweight hand-held depth integrating sampler used for the collection of suspendedsediment samples in wadeable streams. ',
  'DH-95':
    'The US DH-95TM14 is a hand-line suspended-sediment/water-quality sampler.',
  'Danish Seine Net':
  ...
  'Drilled Sampler':
    'Testing and Sampling both soil or rock samples taken at desired depth intervals',
  'Drive Sampler (Generic)':
    'The Drive Sampler is used to sample the in-place soil by driving a thin-walled tube to obtain a soil sample of known volume.',
  'Drop Net':
    'Used for one-man bait catching.  A net dropped from bridge, pier , boat, any place over water. ',
  'Ekman Grab':
    'A soft sediment sampler. Sediments must be free from debris and plant growth. Takes a disturbed sample from very soft top layers. Spring loaded jaws prevent loss of material therefore you must ensure no small stones or stalks prevent the closure of grab and so loss of your sample.',
  'Electric Seine':
    'A electrified net used to collect fish that hangs vertically in the water. It can be moved up and down the stream to collect fish.  ',
  'Electroshock (Other)':
  ...
  'Hester-Dendy':
    'The HesterDendy is a sampler suspended at several depths, float at the surface or attach to submerged objects such as boulders or stakes. Rubber tubing is used to allow for the swelling of the plates when they absorb water.  There are square and EPA Round plates.',
  ...
  'Kemmerer Bottle':
    'Water sampler (vertical water bottle) is used for general water sampling in lakes, channels, wells and the sea. This sampler consists entirely out of plastic parts so that there is no risk of the sample coming into contact with metal. The Kemmerer water sampler holds 1.2 litre.',
  'Kick Net':
  ...
  'MTD Net': '',
  'Marmap Neuston Net':
    'A net that is mainly used to collect neuston and is pulled by a research vessel. Neuston consists of organisms living in the upper 10 cm of the water column.',
  'Meteorological Data': '',
  'Minnow Seine Net':
    'A net used to collect bait fish like minnows. It is made of a small mesh size with wooden poles on both ends.',
  'Miscellaneous (Other)': '',
  'Mochness Net':
    'MOCNESS is the acronym for Multiple Opening/Closing Net and Environmental Sensing System and is a net system for plankton in the ocean.',
  'Modified Surber Sampler':
    'Used for taking quantitative samples of organisms that live in the sediment or gravel of stream beds where the water flow is less than 10cm/s.',
  'Nansen Bottle':
    'A device for obtaining samples of water at a specific depth. It was designed in 1894 by Fridtjof Nansen and further developed by Shale Niskin in 1966.',
  'Natural Substrate': '',
  'Net Vertical Tow (Other)': '',
  'Net/Horizontal Tow (Other)': '',
  'Net/Non Tow (Other)': '',
  'Niskin Bottle':
    'A plastic cylinder with stoppers at each end in order to seal the bottle completely. This device is used to take water samples at a desired depth without the danger of mixing with water from other depths.',
  'Norpac Net': 'A plankton net.',
  'Orange-Peel Grab': '',
  'Original Surber Sampler': '',
  'Osterberg Piston Sampler':
    'This is an hydraulic piston sampler, suitable for sampling in silty, clay and medium-fine grain soils, characterized by a medium-low consistency.',
  'Other Toxicant': '',
  'Otter Trawl':
    'A large fish net that is dragged behind a research vessel along the sea bottom or the pelagic zone. The otter trawl is mainly used to catch roundfish living above the sea bottom such as whiting and cod.',
  ...
  'Petite Ponar Grab':
    'Widely used in fresh and salt water for taking samples of hard bottoms such as sand, gravel, consolidated marl or clay. The Petite Ponar Grab is much lighter than the Standard Ponar and designed for hand-line operation. ',
  'Phleger Corer (Gravity)':
    'A gravity corer is just a weighted pipe that is allowed to free fall into the water and enables a corer to capture a sediment sample.',
  'Pipe Dredge': '',
  ...
  'Ponar Grab':
    'Widely used in fresh and salt water for taking samples of hard bottoms such as sand, gravel, consolidated marl or clay. The Standard Ponar is deliberately heavy device for biting deep into the bottom and has proven success at invertebrate recovery. ',
  'Portable sediment centrifuge':
    'Portable centrifuge designed to separate suspended sediment from surface water by pumping surface water through a centrifuge, resulting in sediment free water (centrifugate water), and suspended sediment samples.',
  'Pound Net':
    'Pound nets consist of a fence leader that interrupts the movements of target species and a heart that funnels fish into the trap (pound) via a no return mesh tunnel. ',
  'Pram Electroshock': '',
  'Probe/Sensor':
    'An instrument used to assess ambient water or air quality directly.',
  'Pull Sled': '',
  'Pump/Air Lift': '',
  'Pump/Bailer':
    'A pump that has low suction and moderate discharge of liquid and entrained solids. Used to collect fauna samples from sediment.',
  'Pump/Bladder':
    'Pump with an internal bladder using changing air pressure from an air compressor or compressed air tank to draw water.',
  'Pump/Centrifugal': '',
  'Pump/Jet':
    'Water jet pump is used for withdrawing liquids and gases, and for creating a vacuum. Simple operation and easy cleaning. Very low water consumption, constant pressure and high suction.',
  'Pump/Non-Submersible': '',
  'Pump/Peristaltic':
    'A type of positive displacement pump used for pumping a variety of fluids, they are also commonly known as roller pumps. The fluid is contained within a flexible tube fitted inside a circular pump casing (though linear peristaltic pumps have been made).',
  'Pump/Piston': '',
  'Pump/Rotary': '',
  'Pump/Submersible': '',
  'Pump/Turbine': '',
  ...
  'Push Point Sampler':
    'A mini-piezometer pore water sampler for sampling pore water.',
  Quadrat:
  ...
  'Quartz filter':
    'Quartz fiber filters are used for air sampling in acidic gases, stacks, flues and aerosols, particularly at high temperatures and in PM-10 testing.',
  Radiello:
    'A passive/diffusive sampler for environmental monitoring, ambient and outdoor air monitoring, industrial hygiene, industrial air quality (IAQ), personal sampling and breathing zone assessment. ',
  'Rectangular Net': '',
  'Remotely Operated Vehicle': '',
  'Rock Bag':
    'The abundance and generic richness of a macroinvertebrate community in a river or stream is determined by counting the number of species or genera in a standardized sampling unit. Rock bags allow sampling in depths as shallow as five centimeters, and can be flattened to fit stream bed contours.',
  'Rock Basket':
    'The abundance and generic richness of a macroinvertebrate community in a river or stream is determined by counting the number of species or genera in a standardized sampling unit.  Rock baskets are used for the majority of wadeable sites. ',
  'Rock-filled Cone Sampler':
    'The abundance and generic richness of a macroinvertebrate community in a river/stream is determined by counting the number of species or genera in a standardized sampling unit. Remote-retrievable rock-filled cone samplers allow for sampling in sites that are not wadeable. These devices are retrieved by boat using a weighted, funnel-shaped apparatus that is dropped down a line to settle over the cone. The base of the cone is fitted with Nytex mesh to prevent the loss of organisms upon retrieval. ',
  'Roller Frame Trawl':
  ...
  'Sediment sub-core': '',
  'Seine Net':
    'A net that hangs vertically in the water with its bottom edge held down by weights and its top edge buoyed by floats. Seine nets can be deployed from the shore as a beach seine, or from a boat.',
  'Semipermeable Membrane Device':
    'A passive sampling device used to monitor trace levels of organic compounds with a log Kow > 3.',
  ...
  'Ship Sea Chest':
    'Sea chest is used for a rectangular or cylindrical recess in the hull of a ship. The sea chest provides an intake reservoir from which piping systems draw raw water. ',
  'Shipek Grab':
    ' A sampler designed to sample all types of unconsolidated sediments, from soft ooze to small pebbles, which can be collected from near offshore and deep lakes.',
  Shovel:
  ...
  'Sodium Cyanide':
    'Sodium cyanide is an inorganic compound with the formula NaCN. It is a white, water-soluble solid.',
  'Spear/Gun':
  ...
  'Spear/Hawaiian Sling':
    'A Hawaiian sling is a crafty tool that is meant for spearfishing and has a mechanism that is similar to the one that the bows have. ',
  'Split Spoon':
  ...
  'Stream-Side Electroshock':
    'An electrofishing method where the samplers do not enter the stream but rather perform electroshocking from the bank.',
  'Suction Dredge':
    'Operate by sucking through a long tube like some vacuum cleaners but on a larger scale',
  Summa:
    'Passivated stainless steel canisters to collect sampling of volatile organic compounds (VOCs) in ambient air. ',
  'Surber Sampler':
    'Used by professional monitoring programs, this sampler delineates an exact stream bottom area to be disturbed.',
  Syringe:
    'A device that supplies a focused stream of compressed air, water, or a combination of both.',
  'T-Sampler': '',
  'Terminal Bag': '',
  ...
  'Tile Plate': '',
  'Tow Net':
    'a fine-meshed net usually much tapered and more or less conical in shape and kept open by a ring or hoop that is towed through water (as for the taking of plankton)',
  'Towed Dredge': '',
  'Trammel Net':
    'A trammel net consists of two/three layers of netting with a slack small mesh inner netting between two layers of large mesh netting to collect demersal species, fish and crustaceans. ',
  'Trap Net': '',
  'Trap Substrate (Other)': '',
  'Traveling Screen':
    'A traveling screen is a type of water filtration device that has a continuously moving mesh screen that is used to catch and remove debris.',
  Trawl:
  ...
  'Turbidity Column':
    'turbidity column is a tube used for visual measurements of water turbidity. A second column is required for comparison with a known amount of turbidity. Turbidity meters (also called turbidimeters) determine the concentration of solids in a sample of liquid (usually water). Turbidity is the cloudiness of a liquid caused by the presence of suspended solids (particles) that may include microorganisms, yeast, or sediment.',
  ...
  'USGS collection method tributary samples':
  ...
  'Variable voltage pulsator unit':
    'An electrofisher that employs a direct electric current which provides control and  metering to allow consistency with previous samplings to attract and usually temporarily immobilize fish.',
  'Vibrating Corer':
    'A sample corer that uses vibration to help the core penetrating the sediment.',
  'Video Camera':
  ...
  'Whirl-pak bag':
    'Sterile polyethylene bags with sodium thiosulfate that are disposable, transparent bags for water sampling.',
  'Wide mouth glass jar': 'Glass Straight Sided Wide Mouth Jars',
  'Wisconsin-Style Net':
    'this net enables quantitative vertical plankton hauls.',
  'XAD resin':
    'A type of sampling media used in air sampling, onto/into which the contaminant is collected. Resin is a hydrophobic organic porous polymer.',
  'XAD-2 resin':
    'A type of sampling media used in air sampling, onto/into which the contaminant is collected. Resin is a hydrophobic organic porous polymer.',
  'Yankee Trawl': 'Two Panel Net',
  'Young Grab':
    'The Young Grab, or the Young Modified Van Veen Grab Sampler is an instrument to sample sediment in the ocean. It is a modified version of the Van Veen grab sampler, with a clamshell bucket made out of stainless steel mounted to a supporting frame.',
  'pH Comparator': 'Used to test pH.',
  'pH Paper':
    'A filter paper that is treated with natural water soluble dye from lichens. pH paper is used as an indicator to test the acidity of water-based liquids.'
}
