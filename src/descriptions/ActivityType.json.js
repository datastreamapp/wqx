export default {
  ...
  'Field Msr/Obs-Continuous Time Series':
    'Continuous time series (sensor) data submitted as calculated statistics (up to 6 per day), with the full time series included as a text file attachment. Measurements are automatically collected in the field by a fixed, deployed single or multi-parameter data logger.',
