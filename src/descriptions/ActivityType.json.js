export default {
  'Field Msr/Obs':
    'MEASUREMENTS involve something measured in its environmental setting usually using some type of equipment.  OBSERVATIONS are made by people, usually without the use of equipment, and are frequently qualitative.',
  ...
  'Field Msr/Obs-Portable Data Logger':
    'Measurements made in the field by an automated data logging device, running "attended or unattended" and producing a suite of data values at repeating intervals set by its owner/operator.',
  ...
  'Quality Control Field Replicate Msr/Obs':
    'A field measurement or observation taken to assess the reproducity of the sampling technique or analytical method.',
  ...
  'Quality Control Sample-Field Ambient Conditions Blank':
    'The analyte free media is tested to assure the preciseness of ambient conditions. It helps in controlling the effects of environment on the sample.',
  'Quality Control Sample-Field Blank':
    'A sample of analyte free water poured into a sample container in the field, preserved and shipped to the laboratory with field samples.  The purpose of a field blank is to assess contamination from field conditions during sampling.',
  ...
  'Quality Control Sample-Lab Blank':
    'Lab Blanks are  analyte-free matrices prepared in the lab and analyzed with samples to identify potential lab sources of contamination.',
  'Quality Control Sample-Lab Continuing Calibration Verification':
    'A check standards run at set points during the analysis',
  'Quality Control Sample-Lab Control Sample/Blank Spike':
    'In the lab deionized water is spiked with all the analytes in concentrations close to those in the field samples, prepared as a sample, and run/re-run on a set frequency.',
  'Quality Control Sample-Lab Control Sample/Blank Spike Duplicate':
    'In the lab deionized water is spiked with all the analytes in concentrations close to those in the field samples, prepared as a sample, and run/re-run on a set frequency.',
  'Quality Control Sample-Lab Control Standard':
    'Lab Control Standard - A standard, certified by an outside agency, used to measure the bias in a procedure. For certain constituents and matrices use NIST Standard Reference Materials when available.',
  ...
  'Quality Control Sample-Lab Initial Calibration Verification':
    'A initial check standards run after the calibration curve',
  'Quality Control Sample-Lab Matrix Spike':
    'An aliquot of an environmental sample to which known quantities of analytes are added in the laboratory.  The matrix spike is analyzed in an identical manner as the sample.',
  ...
  'Quality Control Sample-Lab Split':
    'A sample split in the laboratory from half of a mother or parent sample.',
  'Quality Control Sample-Lab Surrogate Control Standard':
    'Surrogate Standard - A pure compound added to a sample in the lab before processing so that the efficiency of the method can be determined.',
  'Quality Control Sample-Lab Surrogate Control Standard Duplicate':
    'Surrogate Standard - A pure compound added to a sample in the lab before processing so that the efficiency of the method can be determined. The purpose of duplicates is to test for laboratory bias. Duplicate samples are used to assess variance of the total method including sampling and analysis.',
  'Quality Control Sample-Lab Surrogate Method Blank':
    'Surrogate - Organic compounds which are similar to analytes of interest in chemical composition, extraction, and chromatography, but are not found in the environmental samples. These compounds are spiked into blanks, calibration standards, check standards, samples and spiked samples. Percent recovery are calculated for each surrogate.',
  'Quality Control Sample-Measurement Precision Sample':
    'A sample (i.e., test sample or control sample/standard) used either singly or in replicate, as appropriate, to monitor the precision of method.',
  'Quality Control Sample-Other':
    'This category contains quality control measures of any other process to which a sample is subjected, and not included in this list.',
  'Quality Control Sample-Post-preservative Blank':
    'The analyte-free media which has undergone the same preserving process as the samples. This Blank is tested to check the quality of the preservation process.',
  ...
  'Sample-Composite Without Parents':
    'Describes a sample which is a composite of either several discrete sampling events not described elsewhere, or is a sample collected by a continuous process over some time period. No database record exists as its parent.',
  'Sample-Depletion Replicate':
    'Lab Blanks are  analyte-free matrices prepared in the lab and analyzed with samples to identify potential lab sources of contamination.',
  'Sample-Field Split':
    'A sample created in the field from half of a mother or parent sample.',
  'Sample-Field Subsample':
    'A sample created in the field from a portion of a mother or parent sample',
  'Sample-Integrated Cross-Sectional Profile':
    'A discrete/integrated sample, usually derived from a continuous record, representing cross-section of the stream.',
  ...
  'Sample-Integrated Time Series':
    'A discrete/integrated sample, usually derived from a continuous record, representing some portion or segment of elapsed time within the overall activity duration or sample period.',
  ...
  'Sample-Routine':
    'A sample gathered using straightforward grab  procedures for purposes of a general evaluation of the environment at the site.',
  'Sample-Routine Resample':
    'A RE-sample (second or more) gathered using straightforward grab  procedures for purposes of a general evaluation of the environment at the site.'
}
