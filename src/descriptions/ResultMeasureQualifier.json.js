export default {
  ...
  C40: 'Dual Column result difference >40%',
  ...
  DIL: 'Not all dilutions yielded acceptable results; results from most acceptable dilution reported ',
  ...
  EMCL: 'Value Exceeds Maximum Contaminant Level',
  ...
  EX: 'Sample collected in or analyzed with expired materials',
  F: 'Estimated value: compound failed initial calibration check (CCC) or QC criteria',
  F1: 'Sampling not possible due to unforeseen circumstances (weather, construction, etc.)',
  F2: 'Sonde Reading/Sample collected off site location due to accessibility issues',
  F3: 'Duplicate Measurment/Sample not collected',
  F4: 'Meta data missing or incomplete (i.e. precipitation data, tidal state)',
  F5: 'Sonde Malfunction',
  F6: 'Sonde reading taken at incorrect depth',
  F7: 'Comparison between Sonde and Lab Measurement result in unacceptable relative percent difference',
  ...
  H5: 'Test specified to be performed in the field within 15 minutes of sampling; sample was received and analyzed past the regulatory holding time',
  ...
  HTI: 'Holding time for test is immediate; the laboratory measurement, therefore, cannot be used for compliance purposes',
  HV: 'High variability: questionable precision and accuracy',
  ...
  J: 'Estimated value; The analyte was positively identified and the associated numerical value is the approximate concentration of the analyte in the sample.',
  'J+': 'Estimated value; The analyte was positively identified and the associated numerical value is the approximate concentration of the analyte in the sample, and may have a potential positive bias.',
  'J-': 'Estimated value; The analyte was positively identified; the associated numerical value is the approximate concentration of the analyte in the sample, and may have a potential negative bias.',
  ...
  K10: 'Initial Dissolved Oxygen (DO) or temperature conditions of BOD, or Biochemical Oxygen Demand sample unacceptable',
  K11: 'All dilutions result in residual D.O. <1 mg/L',
  K12: 'Test replicates show >30% difference between high and low values',
  K5: 'The dilution water D.O. depletion was > 0.2 mg/L',
  K6: 'Glucose/glutamic acid BOD was below method acceptance criteria',
  K7: 'GGA Average not within 198 +/- 30.5 (167.5-228.5 mg/L)',
  K8: 'Seed Correction Factor outside acceptance criteria ',
  K9: 'Not all BOD or Biochemical Oxygen Demand dilutions depleted sufficiently; highest sample concentration reported',
  ...
  LCS: 'LCS or LCSD',
  LE: 'value extrapolated at low end',
  ...
  M3: 'Spike recovery value unusable since the analyte concentration in the sample is disproportionate to the spike level',
  M4: 'The analysis of the spiked sample required a dilution such that the spike recovery calculation does not provide useful information',
  ...
  MSD: 'MS and/or MSD',
  MSI: 'Sample matrix interference caused MS and/or MSD to be above acceptance limits',
  ...
  OT: 'Oven temperature not maintained',
  OTHER: 'Other',
  OUT: 'Result value is defined as an outlier by data owner',
  P: 'PCDE interference',
  PAM: 'Paperwork (Chain of Custody, Bench Sheet, or Other Record) incomplete or missing',
  ...
  REC: 'Record of sample reciept/condition at lab incomplete',
  REX: 'Re-Prepared',
  RIN: 'Re-Analyzed',
  ...
  STE: 'One or more sterility check not performed, has incomplete record, or failed',
  SUB: 'Sample Subcontracted',
  ...
  V1: 'Continuing calibration verification (CCV) recovery was above method acceptance limits',
