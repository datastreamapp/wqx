export default {
  ...
  Arm: 'Each of the forelimbs of an animal.',
  Bark: 'Bark is the outermost layers of stems and roots of woody plants. Plants with bark include trees, woody vines, and shrubs. Bark refers to all the tissues outside the vascular cambium and is a nontechnical term. It overlays the wood and consists of the inner bark and the outer bark. ',
  Bile: 'A greenish-brown alkaline fluid that aids digestion and is secreted by the liver and stored in the gallbladder.',
  Blood:
  ...
  'Body Wall':
    'The external surface of an animal body that encloses the body cavity.',
  'Bone Tissue':
  ...
  'Bone, Acellular':
    'Not consisting of, divided into, or containing cells.(especially of protozoa) consisting of one cell only. Acellular bone is true bone, differing from all other vertebrate bone in the total lack of enclosed osteocytes',
  'Bone, Cellular':
    'There are two main types of bone cells: osteocytes and osteoblasts. (i.e., bone containing osteocytes that are regularly spaced throughout the bone matrix). Osteoblasts is a cell that secretes the matrix (composed of protein and minerals) for bone formation.',
  'Bone, Marrow':
    'A semi-solid tissue which may be found within the spongy or cancellous portions of bones.',
  Brain:
    'An organ of soft nervous tissue contained in the skull of vertebrates, functioning as the coordinating center of sensation and nervous activity.',
  ...
  Fin: 'A flattened appendage on various parts of the body of many aquaticvertebrates and some invertebrates',
  ...
  'Fish Scales': 'A small rigid plate that grows out of the skin of a fish. ',
  Flower:
    'The seed-bearing part of a plant, consisting of reproductive organs (stamens and carpels) that are typically surrounded by a brightly colored corolla (petals) and a green calyx (sepals).',
  Foot: 'The lower extremity of the leg below the ankle, on which an animal stands or walks.',
  'Fore Gut': 'The anterior part of the gut, toward the mouth.',
  Fruit:
    'The sweet and fleshy product of a tree or other plant that contains seed and can be eaten as food.',
  'Gall Bladder':
    'The small sac-shaped organ beneath the liver, in which bile is storedafter secretion by the liver and before release into the intestine.',
  'Gill Rakers':
    'Bony or cartilaginous outgrowths that project from the branchial arch.',
  Gills:
    'The respiratory organ of fishes and some amphibians, by which oxygen is extracted from water flowing over surfaces within or attached to the walls of the pharynx.',
  Gonads: 'An organ that produces gametes; a testis or ovary.',
  Gut: 'The stomach or belly.',
  Head: 'The front or upper part of the body of an animal, typically separated from the rest of the body by a neck, and containing the brain, mouth, and sense organs.',
  Heart:
  ...
  'Mixed Parts': '',
  'Muscle, Somatic': 'includes most skeletal muscle.',
  'Muscle, Visceral':
  ...
  'Muscle/Muscle Tissue':
    'A band or bundle of fibrous tissue in an animal body that has the ability to contract, producing movement in or maintaining the position of parts of the body.',
  'Nerve Tissue':
  ...
  'Root/Tuber': 'A much thickened underground part of a stem or rhizome.',
  Saliva:
  ...
  Stem: 'The main body or stalk of a plant or shrub, typically rising above the ground.',
  Stomach:
