export default {
  ...
  "Adrenal": "Relating to or denoting a pair of ductless glands situated above the kidneys.",
  ...
  "Blood Plasma": "A yellowish liquid component of blood that holds the blood cells in whole blood in suspension.",
  ...
  "Body Wall": "The external surface of an animal body that encloses the body cavity.",
  "Bone Tissue": "Bone tissue (osseous tissue) is a hard tissue, a type of dense connective tissue. It has a honeycomb-like matrix internally, which helps to give the bone rigidity. Bone tissue is made up of different types of bone cells. Osteoblasts and osteocytes are involved in the formation and mineralization of bone; osteoclasts are involved in the resorption of bone tissue.",
  "Bone, Acellular": "Not consisting of, divided into, or containing cells.(especially of protozoa) consisting of one cell only. Acellular bone is true bone, differing from all other vertebrate bone in the total lack of enclosed osteocytes",
  "Bone, Cellular": "There are two main types of bone cells: osteocytes and osteoblasts. (i.e., bone containing osteocytes that are regularly spaced throughout the bone matrix). Osteoblasts is a cell that secretes the matrix (composed of protein and minerals) for bone formation.",
  "Bone, Marrow": "A semi-solid tissue which may be found within the spongy or cancellous portions of bones.",
  "Brain": "An organ of soft nervous tissue contained in the skull of vertebrates, functioning as the coordinating center of sensation and nervous activity.",
  ...
  "Digestive Gland": "a glandular organ of digestion present in crustaceans, mollusks, and certain other invertebrates.",
  ...
  "Fat/Adipose Tissue": "A natural oily or greasy substance occurring in animal bodies, especially when deposited as a layer under the skin or around certain organs.",
  ...
  "Gall Bladder": "The small sac-shaped organ beneath the liver, in which bile is storedafter secretion by the liver and before release into the intestine.",
  "Gill Rakers": "Bony or cartilaginous outgrowths that project from the branchial arch.",
  "Gills": "The respiratory organ of fishes and some amphibians, by which oxygen is extracted from water flowing over surfaces within or attached to the walls of the pharynx.",
  ...
  "Hepatopancreas": "A glandular organ of digestion present in crustaceans, mollusks, and certain other invertebrates.",
  "Hind Gut": "The posterior part of the gut, toward the anus.",
  "Intestine": "The lower part of the digestive system from the end of the stomach to the anus.",
  ...
  "Tentacles": "A slender, flexible limb or appendage in an animal, especially around the mouth of an invertebrate, used for grasping or moving about, or bearing sense organs.",
  ...
  "Tissue+Mantle Cavity Fluid": "The mantle cavity is a central feature of molluscan biology. This cavity is formed by the mantle skirt, a double fold of mantle which encloses a water space. This space contains the mollusc's gills, anus, and organs for taste, excretion and reproductive organs.",
  "Tissue, Unspecified": "Any of the distinct types of material of which animals or plants are made, consisting of specialized cells and their products.",
  ...
  "Whole Organism": "An organism may be defined as an assembly of molecules functioning as a more or less stable whole that exhibits the properties of life. Any individual entity that embodies the properties of life such as \"any living structure, such as a plant, animal, fungus or bacterium, capable of growth and reproduction\"",
  "Whole, No Exoskeleton/Shell": "Whole organism, no exoskeleton or shell",
  "Whole, NoStomachContents/Gills": "Whole organism, no stomach contents or gills",
  "Whole, Not Gut": "",
