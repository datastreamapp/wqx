export default {
  ...
  "Bed Sediment": "The layers of sedimentary rocks that are distinctly different from overlying and underlying subsequent beds of different sedimentary rocks. ",
  ...
  "Filtered field and/or lab": "Filtering may have been performed in the field, lab, or both. Pertains to constituents in a sample passed through a membrane or fibrous filter.",
  "Filtered, field": "Performed in the field. Pertains to constituents in a sample passed through a membrane or fibrous filter.",
  "Filtered, lab": "Performed in the lab. Pertains to constituents in a sample passed through a membrane or fibrous filter.",
  ...
  "Leachable": "An analyte capable of being removed from a substance by a percolating liquid.",
  "Non-Filterable (Particle)": "That portion of the analyte which is extracted from the SAMPLE medium by filtration.",
  ...
  "Unfiltered, field": "Performed in field. +/ Pertains to the constituents in a representative water-suspended-solids sample. (whole)",
  ...
  "non-linear function": "non-linear function compensation is correction methods for signal distortions"
}