export default {
  ...
  Geologic:
    'A formation is a body of strata of predominantly one type. The concept of formally defined layers or strata is central to the geologic discipline of stratigraphy',
  Hydrogeologic:
  ...
  Mixed:
    'a eformulate coalition formation in a mixed-motive situation as a process in which two group members join their resources',
  'Sediment, Alluvium/Terrace': '',
  'Sediment, Isolated Terrace': '',
  'Sediment, Terrace': '',
  'Sediment, Unconsolidated':
    'a well report/boring was sufficient to describe the surficial materials (soil) or to describe  unconsolidated rock, sediments in an undefined area. most commonly reported on monitoring well construction reports.',
  'Soil Horizon':
