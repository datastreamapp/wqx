export default {
  ...
  BJHQC:
    'Estimated value, compound also detected in LRB, holding time exceeded, QC problems',
  ...
  CB: 'C B; Co-eluting congener.  Detection in blank.',
  'CB+': 'CCB out high.',
  'CB+J': 'CCB out high. Estimated value between MDL and MQL.',
  CBC: 'No Result Reported, cannot be calculated',
  CBD: 'C B D; Co-eluting congener.  Detection in blank.  Dilution required',
  CBDJ: 'C B D J; Co-eluting congener.  Detection in blank.  Dilution required.  Estimated',
  CBJ: 'C B J; Co-eluting congener.  Detection in blank.  Estimated',
  CBL: 'Correction Factor, blank',
  CBQBJ:
    'Co-eluting congener. Below Quantitation Limit. Detection in blank. Estimated.',
  ...
  CD: 'C D; Co-eluting congener.  Detection in blank.  Dilution required',
  CDI: 'Correction Factor, dilution',
  CDJ: 'C D J; Co-eluting congener.  Dilution required.  Estimated',
  CEBDJ:
    'C EMPC B D J; Co-eluting congener.  Estimated maximum possible concentration.  Detection in blank.  Dilution required.  Estimated.',
  CECBJ:
    'C EMPC B J; Co-eluting congener.  Estimated maximum possible concentration.  Detection in blank. Estimated.',
  CECDJ:
    'C EMPC D J; Co-eluting congener.  Estimated maximum possible concentration.  Dilution required.  Estimated.',
  CEMCB:
    'C EMPC B; Co-eluting congener.  Estimated maximum possible concentration.  Detection in blank',
  CEMPC:
    'C EMPC; Co-eluting congener.  Estimated maximum possible concentration',
  CEPCD:
    'C EMPC D; Co-eluting congener.  Estimated maximum possible concentration.  Dilution required.',
  CEPCJ:
    'C EMPC J; Co-eluting congener.  Estimated maximum possible concentration.  Estimated.',
  CJ: 'Co-eluting congener.  Estimated value.',
  ...
  CON: 'Value Confirmed',
  CU: 'Co-eluting congener.  Not detected.',
  CUD: 'C U D; Co-eluting congener.  Not detected.  Dilution required',
  ...
  DBH: 'Contract Required Quantitation Limit (CRQL) not met due to sample matrix interference, dilution required. Detection in blank. Holding time exceeded.',
  ...
  ECBDJ:
    'EMPC B D J; Estimated maximum possible concentration.  Detected in blank.  Dilution required.  Estimated value',
  ...
  EMBDJ:
    'EMPC BDJ; Estimated maximum possible concentration.  Detected in blank. Dilution required.  Estimated value',
  EMCBD:
    'Estimated maximum possible concentration.  Detected in blank. Dilution required.  Estimated value.',
  EMCBJ: 'Estimated maximum possible concentration.  Estimated value.',
  EMCDJ:
    'Estimated maximum possible concentration.  Dilution required.  Estimated value.',
  EMPC: 'Estimated Maximum Possible Concentration',
  EMPCB: 'EMPC B; Estimated maximum possible concentration.  Detected in blank',
  EMPCJ: 'EMPC J; Estimated maximum possible concentration.  Estimated value',
  ENPNF: 'Estimated; Normal protocol not followed',
  EPCBD:
    'EMPC B D; Estimated maximum possible concentration.  Detected in blank.  Dilution required',
  EPCBJ:
    'EMPC B J; Estimated maximum possible concentration.  Detected in blank.  Estimated value',
  EPCD: 'EMPC D; Estimated maximum possible concentration.  Detected in blank.  Dilution required.',
  EPCDJ:
    'EMPC D J; Estimated maximum possible concentration. Dilution required.  Estimated value',
  EQF: 'Equipment failed, sample not analyzed',
  ...
  F1F2B:
    'MS and/or MSD Recovery is outside acceptance limits, MS/MSD RPD exceeds control limits, and compound was found in the blank and sample.',
  ...
  FQCU: 'FQC,U -Quality Control, failed, Not Detected',
  ...
  HMSRJ:
    'High matrix spike recovery, potential high bias, Estimated: The analyte was positively identified and the associated numerical value is the approximate concentration of the analyte in the sample',
  HNRO: 'high native analyte recovery in OPR (or LCS), potential high bias',
  HSRM: 'Likely Biased High. Lab Reference, failed.',
  HTE: 'Hold time exceeded.',
  ...
  'J-R':
    'Approximate value result is below the reporting level but greater than the method detection limit: J, R',
  'J-RB':
    'Approximate value result is below the reporting level but greater than the method detection limit. Detection in blank: B, J, R',
  'J-RH':
    'Approximate value result is below the reporting level but greater than the method detection limit. Holding time exceeded: H, J, R',
  ...
  JDE: 'Estimated: The analyte was positively identified and the associated numerical value is the approximate concentration of the analyte in the sample. And serial dilution acceptance criteria not met.',
  ...
  JHL: 'Estimated: The analyte was positively identified and the associated numerical value is the approximate concentration of the analyte in the sample. Holding time exceeded.  Lowest available reporting limit for the analytical method used.',
  ...
  JLU: 'Result estimated low. Result is less than the MDL.',
  JMQC: 'Estimated value, matrix interference, QC problems',
  JRHQC:
    'Estimated value, between detection limit and reporting limit, holding time exceeded, QC problems: H, J, R, QC',
  JRHT: 'Estimated value, between detection limit and reporting limit and exceeded holding time: H, J, R',
  JRQC: 'Estimated value, between detection limit and reporting limit and QC problems: J, R, QC',
  JT: 'Estimated. Not Detected: The analyte was analyzed for, but was not detected at a level greater than or equal to the level of the adjusted Contract Required Quantitation Limit (CRQL) for sample and method. ',
  JZZ: 'Estimated: These data were qualified as blank-corrected and as undetected when the blank correction resulted in a concentration below the DL.',
  K: 'Value below the detection Limit.  For BOD: depletion is less than 1.0',
  KB: 'Not detected, compound also detected in LRB',
  KBJ: 'Peak deteced but did not meet quantification criteria (result reported represents the estimated maximum possible concentration), analyte found in sample and associated blank and the reported result is an estimate (the value is less than the minimum calibration level but greater than the estimated de',
  KBJHQ:
    'Estimated value, not detected, compound also detected in LRB, holding time exceeded, QC problems',
  KBJQC:
    'Estimated value, not detected, compound also detected in LRB, QC problems',
  KCF: 'Known Contamination, field',
  KJ: 'Estimated value, not detected',
  KJG: 'Peak detected but did not meet quantification criteria (result reported represents the estimated maximum possible concentration), the reporterd result is an estimate (the value is less than the minimum calibration level but greater than the estimated detection limit) and lock mass interference prese',
  ...
  KNBJQ:
    'Estimated value, not detected, compound also detected in LRB, presumptive evidence of nontarget compound, QC problems',
  KNJHT:
    'Estimated value, not detected, presumptive evidence of nontarget compound, holding time exceeded',
  KNJQC:
    'Not detected, presumptive evidence of non-target compound, estimated value, QC problems',
  KRMDL:
    'Reported value was at or below the method detection limit (MDL) and entered at the MDL',
  KRPQL:
    'Reported value was at or below the reporting limit (PQL or LQL) and entered at the PQL',
  ...
  LJHQC:
    'Estimated value, greater than quantitation limit, holding time exceeded, QC problems',
  ...
  LMSRJ:
    'Low matrix spike recovery, potential low bias. Result is less than the MQL but greater than or equal to the MDL and the concentration is an approximate value.',
  LMSRU:
    'low matrix spike recovery, potential low bias.  Result is less than the MDL.',
  LNJQC:
    'Estimated value, greater than quantitation limit, presumptive evidence of nontarget compound, QC problems',
  ...
  LSRM: 'Likely Biased Low. Lab Reference, failed.',
  LSSR: 'Surrogate standard acceptance criteria not met – low',
  LTL: 'Operating Range, less than',
  ...
  NBJQC:
    'Estimated value, presumptive evidence of nontarget compound, compound also detected in LRB, QC problems',
  NFNSI:
    'While comparison of nutrient fractions (e.g. filtered > unfiltered) or nutrient species (e.g. PO4 > TP) results are not consistent, the results are within precision limits and are analytically equal.',
  NFNSU:
    'Comparison of nutrient fractions (e.g. filtered > unfiltered) or nutrient species (e.g. PO4 > TP) are not consistent. Results fall outside the normal limits of variability and do not meet Data Quality Objectives. Reanalyses were performed with consistent results. All QA limits and results were valid',
  ...
  NRS: 'Non Representative Sample',
  NSQ: 'No Result Reported, insufficient quantity of sample',
  NWL: 'Operating Range, not within',
  OA3: 'Outlier, across stations',
  OS3: 'Outlier, single station',
  OTH: 'Other',
  OTHER: 'Other',
  OUT: 'Result value is defined as an outlier by data owner',
  PBH: 'Estimated value, continuous probe biased high Quality control measures failed high at audit check during deployment. Could include pre, mid or post deployment check.',
  PBL: 'Estimated value, continuous probe biased low Quality control measures failed low at audit check during deployment. Could include pre, mid or post deployment check.',
  PKB: 'Peak deteced but did not meet quantification criteria (result reported represents the estimated maximum possible concentration) and analyte found in sample and associated blank',
  PKBJ: 'Peak deteced but did not meet quantification criteria (result reported represents the estimated maximum possible concentration), analyte found in sample and associated blank and the reported result is an estimate',
  PKJG: 'Peak detected but did not meet quantification criteria, the reporterd result is an estimate (the value is less than the minimum calibration level but greater than the estimated detection limit) and lock mass interference present',
  ...
  RRUDL:
    "Lab reported a result value, however the lab's detection limit is not known/available for validation or comparison to the result.",
  RRUDQ:
    "Lab reported a result value, but lab's detection limit not known/available for comparison to the result; however with parameter specific evaluation determined to be quantified.",
  ...
  'SD%SS':
    "MS/MSD RPD exceeds control limits due to sample size difference. (TestAmerica Laboratory with a qualifier code of 'F4')",
  ...
  TT: 'analyte recalculated against alternate labelled compound(s',
  ...
  UB: 'The analyte was detected in the sample and in either the associated laboratory blank or field blank. If detected below the reporting limit (RL) the analyte result was reported as non-detected. If detected above the RL, the analyte result was reported as non-detected.',
  UD: 'U D; Not Detected.  Dilution required.',
  ...
  'UJ-1Z':
    'Result is ≤ the MDL or client requested reporting limit (CRRL). Result reported as the MDL or CRRL. Estimated. A full explanation is presented in the narrative. Holding time and/or preservation requirements not established for this method;BAL recommendations for holding time were not followed.',
  UJL: 'Not Detected. Estimated: The analyte was positively identified and the associated numerical value is the approximate concentration of the analyte in the sample.  Lowest available reporting limit for the analytical method used.',
  ...
  UREJ: 'Value below the detection Limit. Rejected: The sample results are unusable due to the quality of the data generated because certain criteria were not met. The analyte may or may not be present in the sample',
  UZZ: 'Not Detected: These data were qualified as blank-corrected and as undetected when the blank correction resulted in a concentration below the DL.',
